#function to make the train and test data given the whole data
PrepareData=function(df){
  ...
  #================================================================================================
    set.seed(17)
    train_ind =createDataPartition(df[,ncol(df)],p=0.75,list = FALSE)
    train<- df[train_ind, ]
    test <- df[-train_ind, ]
...
#================================================================================================
#function to make the train and test data given the whole data and remove the outliers
...
#================================================================================================
#function to scale a given dataset
